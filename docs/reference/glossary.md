...
This page is the starter reference for CoRE Stack terms, common request fields, spectral indices, and raster band vocabulary. It will grow into a broader field and layer dictionary over time.
...
| `block` | Block name | spatial filtering and task submission |
| `tehsil` | Tehsil or sub-district name | public data queries and layer discovery |
...
- [Geospatial Learning Resources](geospatial-learning-resources.md)
