...
The image is **deps-only** (OS packages, Python/Node libs, entrypoint). Bind-mount three host folders. Same table as [checklist §1](cluster-service-checklist.md#1-store-all-relevant-data-and-compute-output-in-data) and [Tower Services](../infra/tower-services/index.md#shared-terminology).
