...
This is the logic described in the CoRE Stack writeups on:

- [The CoRE stack data structure](https://core-stack.org/the-core-stack-data-structure/)
- [A micro-watershed registry for India](https://core-stack.org/a-micro-watershed-registry-for-india/)
- [CoRE stack starter-kit for geospatial programming](https://core-stack.org/core-stack-starter-kit-for-geospatial-programming/)
- [Understanding water flow for river rejuvenation](https://core-stack.org/planning-river-rejuvenation-over-a-large-stretch/)
