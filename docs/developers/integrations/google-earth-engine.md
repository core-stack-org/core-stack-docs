...
Use this path if you skipped the installer GEE step, are on [Docker Compose](../docker.md#2-configure-gcs-and-google-earth-engine), or want to inspect the account manually.
